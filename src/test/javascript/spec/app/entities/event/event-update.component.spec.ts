...
import EVENTUpdateComponent from '@/entities/event/event-update.vue';
import EVENTClass from '@/entities/event/event-update.component';
...
describe('Component Tests', () => {
  describe('EVENT Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<EVENTClass>(EVENTUpdateComponent, {
        store,
        localVue,
        router,
        provide: {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.eVENT = entity;
        eVENTServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(eVENTServiceStub.update.calledWith(entity)).toBeTruthy();
